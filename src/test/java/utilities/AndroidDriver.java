...
public class AndroidDriver { private static io.appium.java_client.android.AndroidDriver appiumDriver;
    ...
    public static io.appium.java_client.android.AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            if (ConfigReader.getProperty("platformName").equals("Android")) {
                ...
                appiumDriver = new io.appium.java_client.android.AndroidDriver<>(appiumServerURL,caps);
